...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
	...
	private String DUMMY_EMAIL="xuanhoa97@gmail.com";
	private String DUMMY_PASSCODE="12345";
	private String DUMMY_CREDENTIALS = DUMMY_EMAIL + ":" + DUMMY_PASSCODE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailTextView = (AutoCompleteTextView) findViewById(R.id.emailAddress);
        loadAutoComplete();
        //setting email address 
        emailTextView.setText(getEmailAddressPrimary());
    ...
    /**
     * Get email cua account chinh
     * @return
     */
    private String getEmailAddressPrimary()
    {
    	...
    	if(!possibleEmail.equals("")){
    		DUMMY_EMAIL = possibleEmail;
    		DUMMY_CREDENTIALS = DUMMY_EMAIL + ":" + DUMMY_PASSCODE;
    	}
