 ...
 * 
 */
public class IconContextMenu extends DialogFragment implements DialogInterface.OnCancelListener, 
										DialogInterface.OnDismissListener{

	private static final int LIST_PREFERED_HEIGHT = 80;
	...
	public Dialog createMenu(String menuItitle) {
		...
		final AlertDialog.Builder builder = new AlertDialog.Builder(parentActivity,theme);
