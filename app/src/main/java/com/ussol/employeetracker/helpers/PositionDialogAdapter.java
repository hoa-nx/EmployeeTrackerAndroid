...
public class PositionDialogAdapter extends ArrayAdapter{
	...
	public PositionDialogAdapter(Context context, Position[] objects)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		Position cat =(Position) getItem( position );
		if ( cat == null ) {
