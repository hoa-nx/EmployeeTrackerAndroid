...
/**
 * Created by HOA-NX on 2017/01/07.
 */
...
public class BadgeDrawableHelper extends Drawable {
    ...
    public BadgeDrawableHelper(Context context) {
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.Azure));
