...
public class EmployeeTrackerApplicationLifecycleCallbacks implements ActivityLifecycleCallbacks {
	    ...
	    public void onActivityResumed(Activity activity) {
	        ++resumed;
	        //yeu cau hien thi man hinh passcode ( neu co setting la enable passcode)
