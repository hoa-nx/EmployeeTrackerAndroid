...
public class ListDepartmentFragment extends ListFragment {
	...
	/** tag */
	private final static String TAG =ListDepartmentFragment.class.getName();
    /**▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼
     * onCreate
     * 
     ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲*/
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		Button btn = (Button)getView().findViewById(R.id.btnDeptAdd);
		
		btn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
					/** tạo mới phòng ban */
					Intent intentNew = new Intent(getActivity(), EditDepartmentActivity.class);
					...
					startActivityForResult(intentNew , MasterConstants.CALL_DEPT_ACTIVITY_CODE);
		...
		if (getListView().getCount()>0){
			...
			if (SharedVariables.CURRENT_ORIENTATION==Configuration.ORIENTATION_LANDSCAPE){
				...
				Dept item = (Dept) getListAdapter().getItem(first_pos);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		try{
			View v = getView();
			//if (v==null){
				view = inflater.inflate(R.layout.fragment_departmentlist_list,container, false);
			//}
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		Dept item = (Dept) getListAdapter().getItem(position);
	...
	public void bindData(){
		...
		list = mConvertCursorToListString.getDeptList("");
		/** tạo adapter để hiển thị list data  */
		adapter = new DeptAdapter(getActivity(),android.R.layout.simple_list_item_1, list);
		/** gán data */
     ...
     * 
     ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲*/
	private void updateDetail(Dept item){
		try{
			DetailDepartmentFragment fragment = (DetailDepartmentFragment) getFragmentManager()
					.findFragmentById(R.id.detailDepartmentFragment);
			if (fragment != null  && fragment.isInLayout()) {
				fragment.setDepartmentCode(String.valueOf(item.code));
				fragment.setDepartmentName(item.name);
				fragment.setDepartmentManager(item.yobi_text1);
				fragment.setDepartmentVice(item.yobi_text2);
				fragment.setDepartmentCreateDate(item.create_date);
				fragment.setDepartmentNote(item.note);
			}else {
				Intent intent = new Intent(getActivity().getApplicationContext(),DetailDepartmentActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		if (getListAdapter().getCount()-1 < info.position){
			ListPositionFragment fragment = (ListPositionFragment) getFragmentManager()
		...
		Dept detail = (Dept) getListAdapter().getItem(info.position);
		
		switch (item.getItemId()) {
		  case R.id.departmentaddcopy:
			  /** tạo mới từ item chọn */
			  /**  chỉnh sửa */
				Intent intentCopy = new Intent(getActivity(), EditDepartmentActivity.class);
				Bundle bundleCopy = new Bundle();
				/**lấy code của phòng ban */
				bundleCopy.putInt(DatabaseAdapter.KEY_CODE, 0);
				bundleCopy.putParcelable(MasterConstants.TAB_DEPT_TAG, detail);
				/**gán vào bundle để gửi cùng với intent */
				intentCopy.putExtras(bundleCopy);
				/**khởi tạo activity dùng để edit  */
				startActivityForResult(intentCopy, MasterConstants.CALL_DEPT_ACTIVITY_CODE);
				break;
		  case R.id.departmentdetail:
			  /** xem thông tin chi tiết */
			  /**  chỉnh sửa */
				Intent intentDetail = new Intent(getActivity(), DetailDepartmentActivity.class);
		  ...
		  case R.id.departmentedit:
			  /**  chỉnh sửa */
				...
				intent.putExtras(bundle);
				/**khởi tạo activity dùng để edit  */
				startActivityForResult(intent , MasterConstants.CALL_DEPT_ACTIVITY_CODE);
				break;
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		switch(requestCode){
			case MasterConstants.CALL_DEPT_ACTIVITY_CODE:
	...
	private void deleteData(final int  code ){
        ...
        alertDialog.setMessage("Bạn có muốn xóa phòng ban này không?");
        ...
        alertDialog.setPositiveButton(getResources().getText(R.string.titleYes), new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog,int which) {
            	...
            	mDatabaseAdapter.deleteDeptByCode(code);
            	bindData();
