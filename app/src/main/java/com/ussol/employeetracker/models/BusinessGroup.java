...
public class BusinessGroup extends Master {
	
	public static final Parcelable.Creator<BusinessGroup> CREATOR = new Parcelable.Creator<BusinessGroup>() {
    	public BusinessGroup createFromParcel(Parcel in) {
    		return new BusinessGroup(in);
    	}
    ...
    public BusinessGroup(Parcel in) {
    	super(in);
    	mkbn= MasterConstants.MASTER_MKBN_BUSINESS_GROUP; //cố định là 5 
    };
    
    @Override
	public void writeToParcel(Parcel dest, int flags) {
    	dest.writeInt(id);
    	dest.writeInt(MasterConstants.MASTER_MKBN_BUSINESS_GROUP);
    	dest.writeInt(code);
