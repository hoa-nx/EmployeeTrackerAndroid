...
public class UserPositionGroup implements Parcelable {
	
	public int code=0;
	public int user_code=0;
	public int position_group_code=0;
	public String name;
	public String ryaku;
	...
	public static final Parcelable.Creator<UserPositionGroup> CREATOR = new Parcelable.Creator<UserPositionGroup>() {
    	public UserPositionGroup createFromParcel(Parcel in) {
    		return new UserPositionGroup(in);
    	}
 
        public UserPositionGroup[] newArray(int size) {
        	return new UserPositionGroup[size];
        }
    };
    
    public UserPositionGroup() {}
    
    public UserPositionGroup(Parcel in) {
    	code = in.readInt();
    	user_code = in.readInt();
    	position_group_code = in.readInt();
    	name= in.readString();
    	ryaku= in.readString();
    	note =in.readString();
	...
	public void writeToParcel(Parcel dest, int flags) {
    	...
    	dest.writeInt(position_group_code);
