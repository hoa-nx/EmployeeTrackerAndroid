...
public class UserCustomerGroup implements Parcelable {
	
	public int code=0;
	public int user_code=0;
	public int customer_group_code=0;
	public String name;
	public String ryaku;
	...
	public static final Parcelable.Creator<UserCustomerGroup> CREATOR = new Parcelable.Creator<UserCustomerGroup>() {
    	public UserCustomerGroup createFromParcel(Parcel in) {
    		return new UserCustomerGroup(in);
    	}
 
        public UserCustomerGroup[] newArray(int size) {
        	return new UserCustomerGroup[size];
        }
    };
    
    public UserCustomerGroup() {}
    
    public UserCustomerGroup(Parcel in) {
    	code = in.readInt();
    	user_code = in.readInt();
    	customer_group_code = in.readInt();
    	name= in.readString();
    	ryaku= in.readString();
    	note =in.readString();
	...
	public void writeToParcel(Parcel dest, int flags) {
    	...
    	dest.writeInt(customer_group_code);
