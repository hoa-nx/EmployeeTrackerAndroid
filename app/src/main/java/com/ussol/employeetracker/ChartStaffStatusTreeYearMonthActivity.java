...
import com.ussol.employeetracker.helpers.ChartFragmentData.MyValueFormatter;
...
public class ChartStaffStatusTreeYearMonthActivity extends ChartBase  implements OnSeekBarChangeListener,
OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getParentChildInGroup(IExpGroup.EXP_GROUP_STAFF_STATUS_YEARMONTH);
        ...
        if(displayDescriptionOnChart){
        	mChart.setDescription("Thống kê nhân sự so với năm trước");
        }else{
