...
public class ChartStaffStatusWorkingStackedBarChartFrag extends ChartFragmentData implements OnChartGestureListener {
    ...
    public static Fragment newInstance() {
        return new ChartStaffStatusWorkingStackedBarChartFrag();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mChart.setData(getBarDataWorking(getActivity()));
        if(displayDescriptionOnChart){
        	mChart.setDescription("Thống kê số LTV và PD chính thức");	
        }
