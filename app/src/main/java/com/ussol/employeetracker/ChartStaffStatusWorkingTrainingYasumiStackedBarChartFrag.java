...
public class ChartStaffStatusWorkingTrainingYasumiStackedBarChartFrag extends ChartFragmentData implements OnChartGestureListener {
    ...
    public static Fragment newInstance() {
        return new ChartStaffStatusWorkingTrainingYasumiStackedBarChartFrag();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mChart.setData(getBarDataWorkingTrainingYasumi(getActivity()));
        if(displayDescriptionOnChart){
        	mChart.setDescription("Thống kê số nhân viên chính thức-thử việc-nghỉ việc(LTV+PD)");	
        }
