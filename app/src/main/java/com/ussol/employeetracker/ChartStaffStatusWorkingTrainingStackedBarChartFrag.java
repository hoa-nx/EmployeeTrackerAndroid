...
public class ChartStaffStatusWorkingTrainingStackedBarChartFrag extends ChartFragmentData implements OnChartGestureListener {
    ...
    public static Fragment newInstance() {
        return new ChartStaffStatusWorkingTrainingStackedBarChartFrag();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mChart.setData(getBarDataWorkingTraining(getActivity()));
        if(displayDescriptionOnChart){
        	mChart.setDescription("Thống kê số nhân viên chính thức-thử việc(LTV+PD)");	
        }
